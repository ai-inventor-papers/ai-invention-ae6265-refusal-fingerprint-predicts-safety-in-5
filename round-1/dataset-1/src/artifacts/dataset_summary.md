...
**Last verified**: 2026-09-19T02:38:50+00:00 (post-construct audit: registry re-verified live, parameter counts backfilled from safetensors index metadata).
...
| artifacts/registry.json (+full/mini/preview) | 41 rows: 8 base + 8 instruct + 17 community abliterated + 8 self-ablit specs; 27/33 live config-verified; every row has layer/dim + parameter_count + fold |
